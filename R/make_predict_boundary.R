...
#' (mcp)
#' 
#' Primary use is to create a predict boundary for sdm_prep, merging (an
...
#' clipping to a (usually) coastal boundary. This boundary is then used for
#' generation of background points and for masking the predict to the full
...
#'
#' @return if(return_poly) sf else invisible(NULL). .parquet mcp written to out_file
#' @export
#'
#' @examples
