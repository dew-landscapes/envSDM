...
#> Error in (function (.l, .f, ..., .progress = FALSE) {    pmap_("list", .l, .f, ..., .progress = .progress)})(.l = list(structure("/projects/dev/nige/packages/envSDM/inst/examples/chg__0__10__TRUE/prep.rds", class = c("fs_path", "character")), structure("/projects/dev/nige/packages/envSDM/inst/examples/chg__0__10__TRUE", class = c("fs_path", "character"))), .f = function (...) {    NULL    NULL    ...furrr_out <- ...furrr_fn(...)    NULL}): ℹ In index: 1.
